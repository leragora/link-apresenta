...
viewOpts = {"title":0,"page":0,"zoom":0,"fs":0,"pdf":0,"toc":0,"thumbs":0,"progress":1,"showbar":1,"bg":"#000","loadText":"carregando...","footer":0};
...
var presmode = {"enabled":1,"fsdc":1,"keynav":1,"clicknav":1,"fshidenav":1,"fshidevd":1,"buildclick":0,"buildbullet":0,"builddimbullet":0,"savehome":0,"autoplay":0,"loop":0,"slideduration":5};
...
if(presmode.fsdc && fullscreenEnabled()){
	var $fsnote = $(
    '<div id="fs-note-wrap" style="' +
        'position:fixed;' +
        'width:100%;' +
        'height:100%;' +
        'pointer-events:none;' +
    '">' +
        '<span id="fs-note" style="' +
            ...
            'top:50%;' +
            'left: 50%;' +
            prefix.css + // Variável externa para prefixos de navegador
            'transform:translate(-50%,-50%);' +
        '">' +
            'Clique duas vezes para uma melhor experiência de leitura.' +
        '</span>' +
    '</div>'
);
	$('body').append($fsnote.fadeIn(999).delay(2000).fadeOut(999));
